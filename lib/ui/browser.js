...
(function($) {
  ...
  BrowserUserInterface.prototype.displayContent = function(paragraphs, faceImage, bannerImage) {
    ...
    if (bannerImage) {
        hasImage = true;
        // convert bannerImage into an html object
        console.log(bannerImage);
        //var cardEl = $('<div>').addClass('face-figure');
        var cardEl = document.createElement('div');
        cardEl.className = "face-figure";
        //var $image = $('<img>').addClass('face-img').attr({src : bannerImage});
        var image = new Image();
        image.className = "face-img";
        cardEl.appendChild(image);
        $html.splice(1, 0, cardEl);

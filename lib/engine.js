...
(function() {
  ...
  UserInterface.prototype.displayContent = function(paragraphs, faceImage, bannerImage) {};
  ...
  DendryEngine.prototype.displaySceneContent = function(restorePage) {
    ...
    if (restorePage) {
      this.ui.newPage();
      this.ui.displayContent(this.state.tempCurrentContent, faceImage, bannerImage);
    ...
    if (scene.content !== undefined && !restorePage) {
      ...
      this.ui.displayContent(displayContent, faceImage, bannerImage);
    }
